...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código:
  nuevoArray = array.push(elemento)
  return array
}
...
function agregarItemAlComienzoDelArray(array, elemento) {
  ...
  // Tu código:
  nuevitoArray = array.unshift(elemento)
  return array
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  //todos los elementos / resultadosTest.length 
  var totalDePuntaje = 0
  for (i = 0; i < resultadosTest.length; i++) {
    totalDePuntaje += resultadosTest[i]
  }
  return totalDePuntaje / resultadosTest.length
}
...
function mayorACien(array) {
  ...
  // Tu código:
  var nuevoArrayNumeros = []
  for (i = 0; i < array.length; i++) {
    if (array[i] > 100) {
      nuevoArrayNumeros.push(array[i])
    }
  }
